...
public class ExplosivePhantomRenderer extends MobRenderer<ExplosivePhantomEntity, PhantomModel<ExplosivePhantomEntity>> {
	public ExplosivePhantomRenderer(EntityRendererProvider.Context context) {
		super(context, new PhantomModel(context.bakeLayer(ModelLayers.PHANTOM)), 0.75f);
		this.addLayer(new PhantomEyesLayer<>(this));
	}

	protected void scale(ExplosivePhantomEntity p_115681_, PoseStack p_115682_, float p_115683_) {
	...
	protected void setupRotations(ExplosivePhantomEntity p_115685_, PoseStack p_115686_, float p_115687_, float p_115688_, float p_115689_) {
	...
	@Override
	public ResourceLocation getTextureLocation(ExplosivePhantomEntity entity) {

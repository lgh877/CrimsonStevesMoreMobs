...
public class TamedPhantomRenderer extends MobRenderer<TamedPhantomEntity, PhantomModel<TamedPhantomEntity>> {
	public TamedPhantomRenderer(EntityRendererProvider.Context context) {
		super(context, new PhantomModel(context.bakeLayer(ModelLayers.PHANTOM)), 0.75f);
		this.addLayer(new PhantomEyesLayer<>(this));
	}

	protected void scale(TamedPhantomEntity p_115681_, PoseStack p_115682_, float p_115683_) {
	...
	protected void setupRotations(TamedPhantomEntity p_115685_, PoseStack p_115686_, float p_115687_, float p_115688_, float p_115689_) {
	...
	@Override
	public ResourceLocation getTextureLocation(TamedPhantomEntity entity) {

public class ModelCustomHoglinModel<T extends PathfinderMob> extends AgeableListModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "custom_hoglin_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition1.addOrReplaceChild("mane", CubeListBuilder.create().texOffs(90, 33).addBox(0.0F, 0.0F, -9.0F,
				0.0F, 10.0F, 19.0F, new CubeDeformation(0.001F)), PartPose.offset(0.0F, -14.0F, -5.0F));
		...
		partdefinition2.addOrReplaceChild("right_ear",
		...
		partdefinition2.addOrReplaceChild("left_ear",
	...
	public void setupAnim(T p_102744_, float p_102745_, float p_102746_, float p_102747_, float p_102748_,
			float p_102749_) {

...
public class Modelredstone_grandarmor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "redstone_grandarmor"), "main");
	...
	private final ModelPart right_shoulderpad;
	private final ModelPart left_shoulderpad;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Left_shoe = partdefinition.addOrReplaceChild("Left_shoe", CubeListBuilder.create()
				.texOffs(24, 32).addBox(-1.9F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)),
				PartPose.offset(1.9F, 12.0F, 0.0F));

		PartDefinition leggingsRight = partdefinition.addOrReplaceChild("leggingsRight",
				CubeListBuilder.create().texOffs(0, 34).mirror()
						.addBox(-2.1F, 0.0F, -2.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.25F)).mirror(false),
				PartPose.offset(-1.9F, 12.0F, 0.0F));

		PartDefinition leggingsLeft = partdefinition.addOrReplaceChild("leggingsLeft", CubeListBuilder.create()
				.texOffs(0, 34).addBox(-1.9F, 0.0F, -2.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(1.9F, 12.0F, 0.0F));

		PartDefinition right_shoulderpad = partdefinition.addOrReplaceChild("right_shoulderpad",
				CubeListBuilder.create().texOffs(32, 0).mirror()
						.addBox(-4.0F, -4.0F, -3.0F, 5.0F, 7.0F, 6.0F, new CubeDeformation(0.3F)).mirror(false)
						.texOffs(10, 42).mirror()
						.addBox(-6.5F, -1.0F, -3.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.3F)).mirror(false),
				PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition left_shoulderpad = partdefinition.addOrReplaceChild("left_shoulderpad",
				CubeListBuilder.create().texOffs(32, 0)
						.addBox(-1.0F, -4.0F, -3.0F, 5.0F, 7.0F, 6.0F, new CubeDeformation(0.3F)).texOffs(10, 42)
						.addBox(4.5F, -1.0F, -3.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.3F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));
		...
		PartDefinition outer_chestplate = body.addOrReplaceChild("outer_chestplate",
				CubeListBuilder.create().texOffs(0, 17)
						.addBox(14.0F, 0.0F, -2.0F, 9.0F, 12.0F, 5.0F, new CubeDeformation(0.25F)).texOffs(0, 58)
						.addBox(16.0F, 2.0F, 3.0F, 5.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-18.5F, 0.0F, -0.5F));

		PartDefinition inner_chestplate = body.addOrReplaceChild("inner_chestplate", CubeListBuilder.create()
				.texOffs(28, 13).addBox(-18.0F, -3.0F, -2.0F, 8.0F, 15.0F, 4.0F, new CubeDeformation(0.3F)),
		...
		PartDefinition left_horn = head.addOrReplaceChild("left_horn",
				CubeListBuilder.create().texOffs(35, 44).mirror()
						.addBox(2.5F, -35.7738F, -6.2174F, 1.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(40, 32).mirror()
						.addBox(3.5F, -38.75F, -6.25F, 2.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(2.0F, 28.0F, 4.0F));

		PartDefinition right_horn = head.addOrReplaceChild("right_horn",
				CubeListBuilder.create().texOffs(35, 44)
						.addBox(-3.5F, -35.7738F, -6.2174F, 1.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(40, 32)
						.addBox(-5.5F, -38.75F, -6.25F, 2.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 28.0F, 4.0F));

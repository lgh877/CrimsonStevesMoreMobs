public class ModelAnimatedWardenIronGolemModel<T extends PathfinderMob> extends HierarchicalModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "animated_warden_iron_golem_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 40).addBox(-9.0F, -17.0F, -6.0F, 18.0F, 12.0F, 11.0F).texOffs(0, 70)
						.addBox(-4.5F, -5.0F, -3.0F, 9.0F, 5.0F, 6.0F, new CubeDeformation(0.5F)),
		...
		body.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(60, 21).addBox(-2.0F, -2.5F, -3.0F, 4.0F, 30.0F, 6.0F),
				PartPose.offset(-11.0F, -15.0F, 0.0F));
		body.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(60, 58).addBox(-2.0F, -2.5F, -3.0F, 4.0F, 30.0F, 6.0F),
				PartPose.offset(11.0F, -15.0F, 0.0F));
		body.addOrReplaceChild("left_ribcage",
				CubeListBuilder.create().texOffs(110, 0).addBox(-2.0F, -6.0F, -0.2F, 9.0F, 12.0F, 0.0F),
				PartPose.offset(-7.0F, -11.0F, -6.0F));
		body.addOrReplaceChild("right_ribcage",
				CubeListBuilder.create().texOffs(110, 0).mirror().addBox(-7.0F, -6.0F, -0.2F, 9.0F, 12.0F, 0.0F),
				PartPose.offset(7.0F, -11.0F, -6.0F));

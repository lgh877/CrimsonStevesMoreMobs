public class ModelAnimatedWardenCowModel<T extends PathfinderMob> extends HierarchicalModel<T> implements ArmedModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "animated_warden_cow_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild(
				"body", CubeListBuilder.create().texOffs(18, 4).addBox(-6.0F, -18.0F, -5.0F, 12.0F, 18.0F, 10.0F)
						.texOffs(52, 0).addBox(-2.0F, -6.0F, -6.0F, 4.0F, 6.0F, 1.0F),
				PartPose.offset(0.0F, 13.0F, 2.0F));

		body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -5.0F, -6.0F, 8.0F, 8.0F, 6.0F).texOffs(22, 0)
						.addBox(4.0F, -6.0F, -4.0F, 1.0F, 3.0F, 1.0F).texOffs(22, 0)
						.addBox(-5.0F, -6.0F, -4.0F, 1.0F, 3.0F, 1.0F),
				PartPose.offset(0.0F, -18.0F, -2.0F));

		body.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(0, 16).addBox(-1.9F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F),
				PartPose.offset(-4.0F, -12.0F, -6.0F));

		body.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-2.1F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F),
				PartPose.offset(4.0F, -12.0F, -6.0F));

		partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(0, 16).addBox(-1.9F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F),

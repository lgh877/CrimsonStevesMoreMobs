@OnlyIn(Dist.CLIENT)
public class ModelAnimatedWardenModel<T extends PathfinderMob> extends HierarchicalModel<T> implements ArmedModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "animated_warden_model"), "main");
	...
	public ModelAnimatedWardenModel(ModelPart p_233512_) {
		...
		this.bioluminescentLayerModelParts = ImmutableList.of(this.head, this.leftArm, this.rightArm, this.leftLeg,
				this.rightLeg);
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition2.addOrReplaceChild(
				"left_ribcage", CubeListBuilder.create().texOffs(90, 11).mirror()
